...
public class MensaDates extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    Toolbar toolbar;
    static String[] days ={"Monday", "Tuesday", "Wednesday", "Thursday", "Friday"};
    static List<String> daysList = Arrays.asList(days);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView datesList = (ListView) findViewById(R.id.dates_list);
        MensaDatesAdapter adapter = new MensaDatesAdapter(daysList);
        datesList.setAdapter(adapter);
        datesList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick (AdapterView<?> parent, View view, int position, long id){
                Object dateItem = datesList.getItemAtPosition(position);
            }
        });
