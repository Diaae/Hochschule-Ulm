...
public class ActivityMensaCard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    RecyclerView mensaMealPlan;
    MensaView mensaView;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mensa_card);
        ...
        mensaMealPlan = findViewById(R.id.mensaCardView);
        mensaMealPlan.setLayoutManager(new LinearLayoutManager(this));

        mensaView = new MensaView(this, MensaPlan.getList());
        mensaMealPlan.setAdapter(mensaView);
